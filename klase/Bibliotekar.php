...
class Bibliotekar extends KonekcijaDB
{
   ...
   public function Dodavanje()
   {
      ...
      $upit = "INSERT INTO `bibliotekar` (`ID bibliotekara`, `Prezime`, `Ime`, `Email`, `Korisnicka sifra`) VALUES ('$this->IdBibliotekara','$this->Prezime','$this->Ime','$this->Email','$this->KorisnickaSifra');";
   ...
   public function Izmena($pIDbibliotekara)
   {
      ...
      $upit = "UPDATE `bibliotekar` SET `ID bibliotekara`='$this->IdBibliotekara',`Prezime`='$this->Prezime',`Ime`='$this->Ime',`Email`='$this->Email',`Korisnicka sifra`='$this->KorisnickaSifra' WHERE `ID bibliotekara`='pIDbibliotekara';";
      //izvrsavanje SQL upita
      $result = mysqli_query($konekcija, $upit);               
      /*provera rezultata izvrsavanja SQL upita 
      i ispis informacije o gresci*/
