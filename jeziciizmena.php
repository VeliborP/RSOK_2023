		...
		<div class="container">
			<div class="row animate-box">
				<div class="col-md-6 col-md-offset-3 text-center fh5co-heading">
					...
					<form action="jeziciizmenasnimi.php" method="POST">
						<table align="center">
							<tr style="float:center; clear:left; margin-top:10px;"><td>ID Jezika*</td> 
								<td style="float:left; clear:right; margin-top:10px;"><input type="number" name="IdJezika" value="<?php echo $ID;?>" maxlenth=3 size=10 required tabindex=1></td>
							</tr>
							<tr style="float:center; clear:left; margin-top:10px;"><td>Naziv Jezika*</td> 
								<td style="float:left; clear:right; margin-top:10px;"><input type="text" name="NazivJezika" value="<?php echo $Naziv;?>" maxlenth=30 size=20 required tabindex=2></td>
							</tr>
